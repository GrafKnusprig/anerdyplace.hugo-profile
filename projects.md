...
## 3M Peltor X5A headphone conversion
- Beyerdynamic MMX100 headset
- Mini-XLR connector

## Hollowbody guitar build
- CNC milled neck
- lasercut body from 3mm birch plywood
...
## Handheld LoRa device
- project for makeathon Nov. 2025
...
## Mini Retro Cam
- small and convenient, fast digital videocamera
```txt
Short version: for a 1/4” (≈3.2 × 2.4 mm, 4:3) sensor, a 35 mm full-frame equivalent is about a 3.2 mm lens.
...
So if the module lists angles, aim for ~53° horizontal (or ~63° diagonal). If it lists focal length, grab something around 3.2 mm.
```

## Electrical dot pen
- pen that takes standard ball pen mines and moves them like a tattoo machine

# Running Projects

## DIY PC table
- small and robust table made from wood
...
## High fidelty mp3-player
- eps32-cam based
- version 3 on the way

## Feminist art project
- ball pen drawings that provocate

## GURL
- producing an album for Nici Powerwood